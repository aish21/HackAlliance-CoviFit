...
sys.modules['sklearn.neighbors.classification'] = sklearn.neighbors._classification
...
class ClassifierOnlineTest(object):
    ...
    def __init__(self, model_path, action_labels, window_size, human_id=0):
        ...
        with open('/Users/aishwarya/Desktop/HackAlliance-CoviFit/MachineLearning/model/trained_classifier.pickle', 'rb') as f:
